...
files1 <- list.files("D:/data/ClimateNA_data/version3/", pattern="clim_na_DD5_wt_.*\\.tif$", full.names = TRUE)
...
png(file=paste0(outf1, "dd5_wt_time_series_boxplots_v1", ".png"),
    units = "in",
    width = 6.5,
    height = 4.5,
    res = 300)
